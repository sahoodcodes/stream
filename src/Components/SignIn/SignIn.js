        ...
        <div style={{ display: 'flex', alignItems: 'center', minHeight: '100%', justifyContent: 'center' }}>
          <div className="content1-signin col-12  col-md-4">
            ...
            <button onClick={handleSubmit} className="SIGNin">
              {spinner ? <Spinner animation="border" /> : 'Sign In'}
            </button>
            <div>
              <p id="pp">Need Help?</p>
            </div>
            <div>
              <p style={{ display: 'inline-block', marginRight: '45px', marginTop: '10px' }}>New to Netflix?</p>
              <Link
                style={{
              ...
              <br />
              <a style={{ display: 'inline-block', fontSize: '12px' }} href="https://policies.google.com/privacy">
                learn more
              </a>
            </div>
          </div>
